...
" >
" :Gozilla
command! -nargs=0 Gozilla call gtags#gozilla()
command! -nargs=+ -complete=custom,gtags#complete GtagsFunc call gtags#func(<f-args>)
command! -nargs=0 GtagsShowLibPath call gtags#show_lib_path()
command! -nargs=+ -complete=dir GtagsAddLib call gtags#add_lib(<q-args>)
